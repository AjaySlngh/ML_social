...
const CRYPTO_TOPIC_RULES = [
  { name: 'ethereum-core', keywords: ['ethereum', 'eth', 'ether', 'vitalik', 'beaconchain', 'consensuslayer'] },
  { name: 'eth-staking', keywords: ['staking', 'validator', 'validators', 'restaking', 'eigenlayer', 'slashing'] },
  { name: 'liquid-staking', keywords: ['lst', 'lsd', 'steth', 'rseth', 'ezeth', 'reth', 'cbeth'] },
  { name: 'eth-layer2-rollups', keywords: ['rollup', 'rollups', 'layer2', 'l2', 'arbitrum', 'optimism', 'base', 'zksync', 'starknet', 'scroll', 'linea'] },
  { name: 'eip-4844-blobs', keywords: ['eip4844', '4844', 'proto-danksharding', 'danksharding', 'blob', 'blobs', 'blobspace'] },
  { name: 'eth-upgrades-roadmap', keywords: ['pectra', 'eip', 'hardfork', 'hardforks', 'fork', 'forks', 'roadmap'] },
  { name: 'account-abstraction', keywords: ['accountabstraction', 'erc4337', '4337', 'smartwallet', 'smartwallets', 'bundler', 'paymaster'] },
  { name: 'eth-defi', keywords: ['defi', 'uniswap', 'aave', 'curve', 'maker', 'lido', 'compound', 'amm', 'liquidity', 'yield'] },
  { name: 'mev-orderflow', keywords: ['mev', 'builder', 'builders', 'proposer', 'proposers', 'pbs', 'orderflow', 'sandwich'] },
  { name: 'eth-rwa-stablecoins', keywords: ['rwa', 'tokenization', 'stablecoin', 'stablecoins', 'usdc', 'dai', 'usde', 'treasury'] },
  { name: 'eth-ecosystem-ai', keywords: ['agent', 'agents', 'ai', 'depin', 'inference', 'onchainai'] },
  { name: 'eth-nft-gaming', keywords: ['nft', 'nfts', 'erc721', 'erc1155', 'gamefi', 'metaverse'] },
];
